...
*/
			...
			public class RandomSketchAgentInteractionLocks implements CustomLocks {
			
			public RandomSketchAgentInteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw, String role){
                                    
                   if (interaction.equals("FirstSessionInt0") && role.equals("Participant") ){
                            ParticipantFirstSessionInt0DefaultCommControl.addDefaultLocks(lw);
                   }
