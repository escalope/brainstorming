...
public class RandomSketchAgentProtocol implements AgentProtocols{
...
public RandomSketchAgentProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("FirstSessionInt0") && conv.getPlayedRole().equals("Participant")){
		   	DefaultCommControl dcc=new ParticipantFirstSessionInt0DefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new ParticipantFirstSessionInt0StateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
