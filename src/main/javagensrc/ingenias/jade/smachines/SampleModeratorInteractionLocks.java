...
*/
			...
			public class SampleModeratorInteractionLocks implements CustomLocks {
			
			public SampleModeratorInteractionLocks(){};
                  ...
                  if (interaction.equals("FirstSessionInt0")&& role.equals("Moderator")){
                    ModeratorFirstSessionInt0DefaultCommControl.addDefaultLocks(lw);
                  }
